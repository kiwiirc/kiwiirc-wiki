...
=== inline_link_previews
When enabled, clicking the link preview icon within a message will show its preview inline - within the message itself. If disabled, the preview will open at the top of the page and stay there while switching between different channels.

E.g. `"inline_link_previews": true`
